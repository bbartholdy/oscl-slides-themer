...
---
class: middle
<img src="img/transparency_cropped.png" width=650/>
...
`r icons::fontawesome("twitter")`<!-- twitter icon --> [@OSCLeiden](https://twitter.com/OSCLeiden) `r icons::fontawesome("envelope")`<!-- email icon --> [OSCL@leidenuniv.nl](mailto:OSCL@leidenuniv.nl)

<!-- website icon --> https://www.universiteitleiden.nl/open-science-community-leiden/
